...
export default function MainInfo({data}){
    return (
      <section className="bg-primary flex flex-col lg:flex-row w-full h-fit pt-12 lg:pt-28">
        <div className="hidden sm:flex flex-row lg:flex-col space-x-2 w-full p-4">
          <div className="relative bg-white aspect-square w-full rounded-2xl">
            <Image
              src={data.image1}
              alt="p"
              fill
          ...
          <div className="flex flex-col lg:flex-row w-1/3 lg:w-full space-y-2 lg:space-x-2 lg:p-2">
            <div className="relative bg-white aspect-square w-full rounded-2xl">
              <Image
                src={data.image1}
                alt="p"
        ...
        <div className="w-full h-full py-2 lg:py-8 px-4 flex flex-col justify-between items-center text-center">
          <div className="w-full flex flex-col justify-center items-center space-y-4">
            ...
            <p className="p font-secondary">{data.description}</p>
          </div>
          <div className="w-full space-y-4">
            ...
            <div className="w-full space-y-4 sm:space-y-2">
              ...
              <div className="flex flex-col space-y-4 sm:sapce-y-0 sm:flex-row w-full">
