            ...
            <div className="flex flex-col-reverse lg:flex-col">
              <div className="w-full">
                <div className="space-y-4">
                  <p className="font-primary text-white h3 text-center">
                    Немає продуктів у кошику
                  </p>
                </div>
              </div>
                      ...
                      <CardContent>
                        <div className="relative aspect-square w-24 sm:w-12 h-auto bg-white rounded-lg">
                          {item.image ? (
                            ...
                            <div className="flex h-full items-center justify-center p-2 text-center text-xs font-primary text-primary">
                              Фото
                            </div>
                          )}
                        </div>
          ...
          <DialogContent className="bg-primary">
            <DialogHeader>
              <DialogTitle className="font-primary text-2xl text-center">
                Введіть свої дані для підтвердження замовлення
              </DialogTitle>
